...
public class MathUtilBuilder extends MathUtil {
    ...
    public MathUtilBuilder() {
        this(null, "",null, false);
    }

    public MathUtilBuilder(String content) {
        this(null, content,null, false);
    }

    public MathUtilBuilder(String username, String content, String avatar_url) {
        this(username, content, avatar_url, false);
    }
    public MathUtilBuilder(String username, String content, String avatar_url, boolean tts) {
    ...
    public static class Builder {
        private final MathUtilBuilder message;

        public Builder() {
            this.message = new MathUtilBuilder();
        }
        public Builder(String content) {
            this.message = new MathUtilBuilder(content);
        }
