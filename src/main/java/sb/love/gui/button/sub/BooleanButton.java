package sb.love.gui.button.sub;

import sb.love.Cute;
import sb.love.gui.button.ModuleButton;
import sb.love.gui.button.SubButton;
...
public class BooleanButton extends SubButton {
    ...
    private int getColor(int mouseX, int mouseY){
        Color color = setting.getValue() ? Cute.getInstance().clientSettings.getColorr(200) : new Color(50, 50, 50, 200);
