package sb.love.gui.button;

import sb.love.Cute;
import sb.love.gui.IGuiComponent;
import sb.love.gui.Panel;
import sb.love.gui.button.sub.BindButton;
import sb.love.gui.button.sub.BooleanButton;
import sb.love.gui.button.sub.EnumButton;
import sb.love.gui.button.sub.SliderButton;
...
public class ModuleButton implements IGuiComponent {
    private sb.love.gui.Panel panel;
    ...
    public ModuleButton(Module module, int x, int y, sb.love.gui.Panel panel) {
        this.panel = panel;
        this.module = module;
        this.x = x;
        this.y = y;
        ...
        int subButtonY = 0;
        for(Setting s : Cute.getInstance().settingManager.getSettingsForMod(module)){
    ...
    private int getColor(int mouseX, int mouseY){
        Color color = module.isEnabled() ? Cute.getInstance().clientSettings.getColorr(200) : new Color(50, 50, 50, 200);
