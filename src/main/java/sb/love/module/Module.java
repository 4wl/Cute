package sb.love.module;

import sb.love.Cute;
import sb.love.managers.ModuleManager;
...
public abstract class Module {
    ...
    public void enable(){
        ...
        Cute.getInstance().moduleManager.getEnabledModules().remove(this);
        Cute.getInstance().moduleManager.getEnabledModules().add(this);
        onEnable();
    }
    ...
    public enum Category{
        COMBAT, RENDER, MISC, GUI, CLIENT, MOVEMENT
    }
    ...
    protected Setting register(String name, Object value){
        return Cute.getInstance().settingManager.register(new Setting<>(name, value, this));
    }
    ...
    protected Setting register(String name, Object value, Object min, Object max){
        return Cute.getInstance().settingManager.register(new Setting<>(name, value, min, max, this));
    }
}
