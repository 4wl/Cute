...
import sb.love.Cute;
import sb.love.event.PlayerKillEvent;
...
public class SoundEffects extends Module {
    public SoundEffects() {
        ...
        Cute.getInstance().log.info("[SoundEffects] Registering Sounds");
        ...
        Cute.getInstance().log.info("[SoundEffects] Successfully Registered Sounds");
    }
    ...
    private SoundEvent registerS(String name){
        SoundEvent soundEvent = new SoundEvent(new ResourceLocation(Cute.MODID, name));
